...
import com.mahao.materialdesigndemo.utils.TopThemeUtils;
...
import static com.mahao.materialdesigndemo.utils.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;

/**
 * Created by Penghy on 2017/7/24.
 */

public abstract class TopBaseTransientBottomBar <B extends TopBaseTransientBottomBar<B>> {
      
        /**
         * Base class for {@link TopBaseTransientBottomBar} callbacks.
         *
        ...
        public abstract static class BaseCallback<B> {
            ...
            /**
             * Called when the given {@link TopBaseTransientBottomBar} has been dismissed, either
             ...
             *
             * @see TopBaseTransientBottomBar#dismiss()
             */
            ...
            /**
             * Called when the given {@link TopBaseTransientBottomBar} is visible.
             *
             * @param transientBottomBar The transient bottom bar which is now visible.
             * @see TopBaseTransientBottomBar#show()
             */
        ...
        static {
            sHandler = new Handler(Looper.getMainLooper(), new Handler.Callback() {
                ...
                public boolean handleMessage(Message message) {
                    switch (message.what) {
                        case MSG_SHOW:
                            ((TopBaseTransientBottomBar) message.obj).showView();
                            return true;
                        case MSG_DISMISS:
                            ((TopBaseTransientBottomBar) message.obj).hideView(message.arg1);
                            return true;
                    }
                    return false;
                }
         ...
         */
        protected TopBaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content,
            ...
            TopThemeUtils.checkAppCompatTheme(mContext);
            ...
            mView = (SnackbarBaseLayout) inflater.inflate(
                    R.layout.top_design_layout, mTargetParent, false);
        ...
        /**
         * Returns the {@link TopBaseTransientBottomBar}'s context.
         */
        @NonNull
        ...
        /**
         * Returns the {@link TopBaseTransientBottomBar}'s view.
         */
        @NonNull
        public View getView() {
            return mView;
        ...
        /**
         * Show the {@link TopBaseTransientBottomBar}.
         */
        public void show() {
        ...
        /**
         * Dismiss the {@link TopBaseTransientBottomBar}.
         */
        public void dismiss() {
        ...
        /**
         * Return whether this {@link TopBaseTransientBottomBar} is currently being shown.
         */
        ...
        /**
         * Returns whether this {@link TopBaseTransientBottomBar} is currently being shown, or is queued
         * to be shown next.
         */
        ...
        final TopSnackbarManager.Callback mManagerCallback = new TopSnackbarManager.Callback() {
            @Override
            public void show() {
                sHandler.sendMessage(sHandler.obtainMessage(MSG_SHOW, TopBaseTransientBottomBar.this));
            }

            @Override
            public void dismiss(int event) {
                sHandler.sendMessage(sHandler.obtainMessage(MSG_DISMISS, event, 0,
                        TopBaseTransientBottomBar.this));
            }
        };
        ...
        final void showView() {
            ...
            mView.setOnAttachStateChangeListener(
                    new TopBaseTransientBottomBar.OnAttachStateChangeListener() {
                        @Override
            ...
            if (ViewCompat.isLaidOut(mView)) {
                ...
                mView.setOnLayoutChangeListener(new TopBaseTransientBottomBar.OnLayoutChangeListener() {
                    @Override
        ...
        static class SnackbarBaseLayout extends FrameLayout {
            private TopBaseTransientBottomBar.OnLayoutChangeListener mOnLayoutChangeListener;
            private TopBaseTransientBottomBar.OnAttachStateChangeListener mOnAttachStateChangeListener;
            ...
            void setOnLayoutChangeListener(
                    TopBaseTransientBottomBar.OnLayoutChangeListener onLayoutChangeListener) {
                mOnLayoutChangeListener = onLayoutChangeListener;
            }

            void setOnAttachStateChangeListener(
                    TopBaseTransientBottomBar.OnAttachStateChangeListener listener) {
